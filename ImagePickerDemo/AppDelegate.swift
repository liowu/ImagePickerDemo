...
extension UIImage {
    ...
    func compress(toSize:CGFloat = 2880) -> UIImage? {
        let longest = size.width > size.height ? size.width : size.height
        if longest < toSize {
            return self
        }
        ...
        let targetWidth:CGFloat = toSize
        ...
        return resizeImage?.fixOrientation()
    }
